    ...
    <>
      ...
      <div className="2xl:container flex mx-auto">
        <SideMenu
          userFirstName={fName}
          userLastName={lName}
          libId={data.libraryInfo.libraryId}
        />
            ...
            >
              ...
              <form method="post">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-6 md:gap-y-6 sm:gap-y-6 p-3">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="idproof" className="text-sm">
                      ID Proof
                    </label>
                    <select
                      name="userIdProof"
                  ...
                  {libraryType == "public" ? (
                    <>
                      ...
                      <div className="flex flex-col">
                        <label htmlFor="mob" className="text-sm">
                          Mobile
                        </label>
                        <input
                          type="tel"
                    ...
                    <>
                      <div className="flex flex-col">
                        <label htmlFor="cour" className="text-sm">
                          Course*
                        </label>
                        <input
                          type="text"
                    ...
                    <>
                      <div className="flex flex-col">
                        <label htmlFor="cla" className="text-sm">
                          Class*
                        </label>
                        <input
                          type="text"
                ...
                <div className="flex p-3">
                  <Button
                    onClick={addUserData}
                    className="bg-rose-900 md:w-40 sm:w-full w-full"
                  >
                    Add User
                  </Button>
                </div>
